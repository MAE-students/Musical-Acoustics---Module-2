...
\newcommand{\chapterbox}[1]{
    \tikz[baseline=(box.base)]{
        \node[rectangle, rounded corners=2pt, fill=bluePoliTO, text=white, inner xsep=10pt, inner ysep=7pt](box){#1};
    }
}
...
\newcommand{\sectionbox}[1]{
    \tikz[baseline=(box.base)]{
        \node[rectangle, rounded corners=1pt, fill=bluePoliTO, text=white, inner xsep=4pt, inner ysep=3pt](box){#1};
    } 
}
